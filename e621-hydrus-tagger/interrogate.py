...
class WaifuDiffusionInterrogator:
    def __init__(
            self,
            name: str,
            model_path='Z3D-E621-Convnext.onnx',
    ...
    def download(self) -> Tuple[os.PathLike, os.PathLike]:
        ...
        model_path = Path('./model/Z3D-E621-Convnext/Z3D-E621-Convnext.onnx')
        tags_path = Path('./model/Z3D-E621-Convnext/tags-selected.csv')
